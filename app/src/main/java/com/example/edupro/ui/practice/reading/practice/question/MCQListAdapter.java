...
public class MCQListAdapter extends RecyclerView.Adapter<MCQListAdapter.ViewHolder> {
    ...
    public MCQListAdapter(ArrayList<MCQQuestion> mcqQuestions, int index, ReadingPracticeViewModel readingPracticeViewModel, MCQClickInterface mcqClickInterface) {
