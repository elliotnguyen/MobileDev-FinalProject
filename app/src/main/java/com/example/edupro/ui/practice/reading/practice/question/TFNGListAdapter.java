...
public class TFNGListAdapter extends RecyclerView.Adapter<TFNGListAdapter.ViewHolder>{
    ...
    private final ReadingPracticeViewModel readingPracticeViewModel;
    public TFNGListAdapter(ArrayList<TFNGQuestion> tfngQuestions, int index, ReadingPracticeViewModel readingPracticeViewModel, MCQClickInterface mcqClickInterface) {
        this.tfngQuestions = tfngQuestions;
        this.index = index;
        this.mcqClickInterface = mcqClickInterface;
        this.readingPracticeViewModel = readingPracticeViewModel;
    }
    @NonNull
    @Override
